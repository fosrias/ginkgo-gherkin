...
Borrowed heavily from https://github.com/onsi/ginkgo/blob/master/reporters/stenographer/stenographer.go
...
func New(color bool, enableFlakes bool) stenographer.Stenographer {
	denoter := "•"
