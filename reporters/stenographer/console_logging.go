...
Re-used from https://github.com/onsi/ginkgo/blob/master/reporters/stenographer/console_logging.go
since methods internal to stenongrapher package. Re-used same implementation here.
